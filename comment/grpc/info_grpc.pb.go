...
type InfoServiceClient interface {
	GetInfo(ctx context.Context, in *RetrieveInfo, opts ...grpc.CallOption) (*Info, error)
}
...
func (c *infoServiceClient) GetInfo(ctx context.Context, in *RetrieveInfo, opts ...grpc.CallOption) (*Info, error) {
	out := new(Info)
	err := c.cc.Invoke(ctx, "/InfoService/GetInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InfoServiceServer interface {
	GetInfo(context.Context, *RetrieveInfo) (*Info, error)
...
func (UnimplementedInfoServiceServer) GetInfo(context.Context, *RetrieveInfo) (*Info, error) {
...
func _InfoService_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/InfoService/GetInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InfoServiceServer).GetInfo(ctx, req.(*RetrieveInfo))
	}
...
var InfoService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "comment/grpc/info.proto",
}
